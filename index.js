...
(async () => {
    ...
    // let element_total = await page.waitForSelector(`#expand-collapse-grouplist-text`)
...
//     await page.keyboard.up('Control');
//     await page.keyboard.press('Backspace');
//     await page.type('#fromDate', '11/1/2022', { delay: 50 })
...
//     await page.keyboard.up('Control');
//     await page.keyboard.press('Backspace');
//     await page.type('#endDate', '11/30/2022', { delay: 50 })
//     await page.click('#SiteSelectorAction', { delay: 50 })
//     await page.click('#selectAllSites', { delay: 50 })
//     await page.click('.dimmedCaption', { delay: 50 })
//     await page.click('#searchButton', { delay: 50 })
